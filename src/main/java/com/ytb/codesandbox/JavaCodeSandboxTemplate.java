...
public abstract class JavaCodeSandboxTemplate implements CodeSandBox {
    ...
    public ExecuteCodeResponse executeCode(ExecuteCodeRequest executeCodeRequest) {
        ...
        if (compileFileExecuteMessage.getExitValue() != 0) {
            outputResponse.setCode(8001);
            outputResponse.setMessage("编译错误");
            //格式化错误信息，删除文件路径
            ...
            outputResponse.setErrorInfo(errorInfo);
            return outputResponse;
        }

        if ((inputTestCaseList == null || inputTestCaseList.isEmpty()) && inputTestCase == null){
            outputResponse.setCode(8005);
            outputResponse.setMessage("测试用例为空");
            return outputResponse;
        }
    ...
    public ExecuteCodeResponse getOutputResponse(List<ExecuteMessage> executeMessageList) {
        ...
        for (ExecuteMessage executeMessage : executeMessageList) {
            ...
            if (StrUtil.isNotBlank(errorMessage)) {
                ...
                executeCodeResponse.setCode(8002);
        ...
        //正常运行完成
        executeCodeResponse.setCode(8000);
